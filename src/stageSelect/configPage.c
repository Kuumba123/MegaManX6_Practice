...
static char* CategoryStrings[8] = {"ALL STAGES","ANY%","100%","ALL STAGES UN-ARMORED","ANY% ULTIMATE ARMOR","ANY% BLACK ZERO","MINIMALIST X-TREME","CUSTOM"};
